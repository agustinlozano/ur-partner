      ...
      <section className="grid md:grid-cols-3 gap-6 max-md:max-w-xs mx-auto ">
        <div
          className={cn(
            ...
            "bg-amber-200/50 dark:bg-gradient-to-t dark:from-[#242424] dark:to-[#020202]",
            ...
            <div className="px-6 py-5">
              <div
                className={cn(
                  ...
                  "bg-background text-foreground group-hover:bg-blue-500 group-hover:text-primary-foreground"
                )}
              >
                online
              </div>
              ...
              <p className="text-sm text-muted-foreground">
                Join a room and make it online with your partner
              </p>
            </div>
        ...
        <div
          className={cn(
            "group relative rounded-2xl border transition-all duration-500 ease-in-out",
            "bg-green-200/50 dark:bg-gradient-to-t dark:from-[#050a0a] dark:to-[#051818]",
          ...
          <div className="relative">
            <div className="px-6 py-5">
              <div
                className={cn(
                  "w-fit px-3 rounded-full text-sm py-1 mb-1 transition-all duration-500 ease-in-out",
                  "bg-green-500 text-primary-foreground group-hover:bg-blue-600 group-hover:text-primary-foreground"
                )}
              >
                discover
              </div>
        ...
        <div
          className={cn(
            "group relative rounded-2xl border transition-all duration-500 ease-in-out",
            "bg-purple-200/50 dark:bg-gradient-to-t dark:from-[#171c35] dark:to-[#000000]",
